  ...
  return (
    ...
    >
      ...
      <div className="bg-white p-6 rounded-lg border border-slate-300 mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-h2 text-slate-900 font-[Chalkboard] mb-1">Compliance dashboard</h1>
          <p className="text-body text-slate-400 font-[Chalkboard]">Monitor employee right to work and policy acknowledgements</p>
        </div>
        ...
        <div className="border-b border-slate-300">
          <div className="flex -mb-px">
            <button
              ...
              className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors font-[Chalkboard] ${
